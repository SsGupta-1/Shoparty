...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        $country = [
            ...
            ['country_code' => 'AS', 'country_name' => 'American Samoa', 'phone_code' => 1684],
            ['country_code' => 'AD', 'country_name' => 'Andorra', 'phone_code' => 376],
            ['country_code' => 'AO', 'country_name' => 'Angola', 'phone_code' => 244],
            ['country_code' => 'AI', 'country_name' => 'Anguilla', 'phone_code' => 1264],
            ['country_code' => 'AQ', 'country_name' => 'Antarctica', 'phone_code' => 0],
            ['country_code' => 'AG', 'country_name' => 'Antigua And Barbuda', 'phone_code' => 1268],
            ...
            ['country_code' => 'BS', 'country_name' => 'Bahamas The', 'phone_code' => 1242],
            ['country_code' => 'BH', 'country_name' => 'Bahrain', 'phone_code' => 973],
            ['country_code' => 'BD', 'country_name' => 'Bangladesh', 'phone_code' => 880],
            ['country_code' => 'BB', 'country_name' => 'Barbados', 'phone_code' => 1246],
            ...
            ['country_code' => 'BM', 'country_name' => 'Bermuda', 'phone_code' => 1441],
            ['country_code' => 'BT', 'country_name' => 'Bhutan', 'phone_code' => 975],
            ['country_code' => 'BO', 'country_name' => 'Bolivia', 'phone_code' => 591],
            ['country_code' => 'BA', 'country_name' => 'Bosnia and Herzegovina', 'phone_code' => 387],
            ['country_code' => 'BW', 'country_name' => 'Botswana', 'phone_code' => 267],
            ['country_code' => 'BV', 'country_name' => 'Bouvet Island', 'phone_code' => 0],
            ['country_code' => 'BR', 'country_name' => 'Brazil', 'phone_code' => 55],
            ['country_code' => 'IO', 'country_name' => 'British Indian Ocean Territory', 'phone_code' => 246],
            ...
            ['country_code' => 'KY', 'country_name' => 'Cayman Islands', 'phone_code' => 1345],
            ...
            ['country_code' => 'CX', 'country_name' => 'Christmas Island', 'phone_code' => 61],
            ['country_code' => 'CC', 'country_name' => 'Cocos Keeling) Islands', 'phone_code' => 672],
            ...
            ['country_code' => 'CD', 'country_name' => 'Democratic Republic Of The Congo', 'phone_code' => 242],
            ['country_code' => 'CK', 'country_name' => 'Cook Islands', 'phone_code' => 682],
            ['country_code' => 'CR', 'country_name' => 'Costa Rica', 'phone_code' => 506],
            ['country_code' => 'CI', 'country_name' => 'Cote D\'Ivoire Ivory Coast)', 'phone_code' => 225],
            ['country_code' => 'HR', 'country_name' => 'Croatia Hrvatska)', 'phone_code' => 385],
            ...
            ['country_code' => 'DM', 'country_name' => 'Dominica', 'phone_code' => 1767],
            ['country_code' => 'DO', 'country_name' => 'Dominican Republic', 'phone_code' => 1809],
            ['country_code' => 'TP', 'country_name' => 'East Timor', 'phone_code' => 670],
            ...
            ['country_code' => 'GQ', 'country_name' => 'Equatorial Guinea', 'phone_code' => 240],
            ...
            ['country_code' => 'XA', 'country_name' => 'External Territories of Australia', 'phone_code' => 61],
            ['country_code' => 'FK', 'country_name' => 'Falkland Islands', 'phone_code' => 500],
            ['country_code' => 'FO', 'country_name' => 'Faroe Islands', 'phone_code' => 298],
            ['country_code' => 'FJ', 'country_name' => 'Fiji Islands', 'phone_code' => 679],
            ['country_code' => 'FI', 'country_name' => 'Finland', 'phone_code' => 358],
            ['country_code' => 'FR', 'country_name' => 'France', 'phone_code' => 33],
            ['country_code' => 'GF', 'country_name' => 'French Guiana', 'phone_code' => 594],
            ['country_code' => 'PF', 'country_name' => 'French Polynesia', 'phone_code' => 689],
            ['country_code' => 'TF', 'country_name' => 'French Southern Territories', 'phone_code' => 0],
            ['country_code' => 'GA', 'country_name' => 'Gabon', 'phone_code' => 241],
            ['country_code' => 'GM', 'country_name' => 'Gambia The', 'phone_code' => 220],
            ...
            ['country_code' => 'GD', 'country_name' => 'Grenada', 'phone_code' => 1473],
            ['country_code' => 'GP', 'country_name' => 'Guadeloupe', 'phone_code' => 590],
            ['country_code' => 'GU', 'country_name' => 'Guam', 'phone_code' => 1671],
            ['country_code' => 'GT', 'country_name' => 'Guatemala', 'phone_code' => 502],
            ['country_code' => 'XU', 'country_name' => 'Guernsey and Alderney', 'phone_code' => 44],
            ['country_code' => 'GN', 'country_name' => 'Guinea', 'phone_code' => 224],
            ['country_code' => 'GW', 'country_name' => 'Guinea-Bissau', 'phone_code' => 245],
            ['country_code' => 'GY', 'country_name' => 'Guyana', 'phone_code' => 592],
            ['country_code' => 'HT', 'country_name' => 'Haiti', 'phone_code' => 509],
            ['country_code' => 'HM', 'country_name' => 'Heard and McDonald Islands', 'phone_code' => 0],
            ['country_code' => 'HN', 'country_name' => 'Honduras', 'phone_code' => 504],
            ['country_code' => 'HK', 'country_name' => 'Hong Kong S.A.R.', 'phone_code' => 852],
            ...
            ['country_code' => 'JM', 'country_name' => 'Jamaica', 'phone_code' => 1876],
            ['country_code' => 'JP', 'country_name' => 'Japan', 'phone_code' => 81],
            ['country_code' => 'XJ', 'country_name' => 'Jersey', 'phone_code' => 44],
            ...
            ['country_code' => 'KP', 'country_name' => 'Korea North', 'phone_code' => 850],
            ['country_code' => 'KR', 'country_name' => 'Korea South', 'phone_code' => 82],
            ...
            ['country_code' => 'MO', 'country_name' => 'Macau S.A.R.', 'phone_code' => 853],
            ['country_code' => 'MK', 'country_name' => 'Macedonia', 'phone_code' => 389],
            ...
            ['country_code' => 'XM', 'country_name' => 'Man Isle of', 'phone_code' => 44],
            ['country_code' => 'MH', 'country_name' => 'Marshall Islands', 'phone_code' => 692],
            ['country_code' => 'MQ', 'country_name' => 'Martinique', 'phone_code' => 596],
            ['country_code' => 'MR', 'country_name' => 'Mauritania', 'phone_code' => 222],
            ['country_code' => 'MU', 'country_name' => 'Mauritius', 'phone_code' => 230],
            ['country_code' => 'YT', 'country_name' => 'Mayotte', 'phone_code' => 269],
            ...
            ['country_code' => 'MS', 'country_name' => 'Montserrat', 'phone_code' => 1664],
            ...
            ['country_code' => 'AN', 'country_name' => 'Netherlands Antilles', 'phone_code' => 599],
            ['country_code' => 'NL', 'country_name' => 'Netherlands The', 'phone_code' => 31],
            ['country_code' => 'NC', 'country_name' => 'New Caledonia', 'phone_code' => 687],
            ...
            ['country_code' => 'NF', 'country_name' => 'Norfolk Island', 'phone_code' => 672],
            ['country_code' => 'MP', 'country_name' => 'Northern Mariana Islands', 'phone_code' => 1670],
            ...
            ['country_code' => 'PS', 'country_name' => 'Palestinian Territory Occupied', 'phone_code' => 970],
            ['country_code' => 'PA', 'country_name' => 'Panama', 'phone_code' => 507],
            ['country_code' => 'PG', 'country_name' => 'Papua new Guinea', 'phone_code' => 675],
            ...
            ['country_code' => 'PN', 'country_name' => 'Pitcairn Island', 'phone_code' => 0],
            ['country_code' => 'PL', 'country_name' => 'Poland', 'phone_code' => 48],
            ['country_code' => 'PT', 'country_name' => 'Portugal', 'phone_code' => 351],
            ['country_code' => 'PR', 'country_name' => 'Puerto Rico', 'phone_code' => 1787],
            ['country_code' => 'QA', 'country_name' => 'Qatar', 'phone_code' => 974],
            ['country_code' => 'RE', 'country_name' => 'Reunion', 'phone_code' => 262],
            ['country_code' => 'RO', 'country_name' => 'Romania', 'phone_code' => 40],
            ['country_code' => 'RU', 'country_name' => 'Russia', 'phone_code' => 70],
            ['country_code' => 'RW', 'country_name' => 'Rwanda', 'phone_code' => 250],
            ['country_code' => 'SH', 'country_name' => 'Saint Helena', 'phone_code' => 290],
            ['country_code' => 'KN', 'country_name' => 'Saint Kitts And Nevis', 'phone_code' => 1869],
            ['country_code' => 'LC', 'country_name' => 'Saint Lucia', 'phone_code' => 1758],
            ['country_code' => 'PM', 'country_name' => 'Saint Pierre and Miquelon', 'phone_code' => 508],
            ['country_code' => 'VC', 'country_name' => 'Saint Vincent And The Grenadines', 'phone_code' => 1784],
            ['country_code' => 'WS', 'country_name' => 'Samoa', 'phone_code' => 684],
            ['country_code' => 'SM', 'country_name' => 'San Marino', 'phone_code' => 378],
            ['country_code' => 'ST', 'country_name' => 'Sao Tome and Principe', 'phone_code' => 239],
            ...
            ['country_code' => 'SL', 'country_name' => 'Sierra Leone', 'phone_code' => 232],
            ...
            ['country_code' => 'XG', 'country_name' => 'Smaller Territories of the UK', 'phone_code' => 44],
            ['country_code' => 'SB', 'country_name' => 'Solomon Islands', 'phone_code' => 677],
            ['country_code' => 'SO', 'country_name' => 'Somalia', 'phone_code' => 252],
            ['country_code' => 'ZA', 'country_name' => 'South Africa', 'phone_code' => 27],
            ['country_code' => 'GS', 'country_name' => 'South Georgia', 'phone_code' => 0],
            ...
            ['country_code' => 'SJ', 'country_name' => 'Svalbard And Jan Mayen Islands', 'phone_code' => 47],
            ['country_code' => 'SZ', 'country_name' => 'Swaziland', 'phone_code' => 268],
            ...
            ['country_code' => 'TT', 'country_name' => 'Trinidad And Tobago', 'phone_code' => 1868],
            ['country_code' => 'TN', 'country_name' => 'Tunisia', 'phone_code' => 216],
            ['country_code' => 'TR', 'country_name' => 'Turkey', 'phone_code' => 90],
            ['country_code' => 'TM', 'country_name' => 'Turkmenistan', 'phone_code' => 7370],
            ['country_code' => 'TC', 'country_name' => 'Turks And Caicos Islands', 'phone_code' => 1649],
            ...
            ['country_code' => 'UM', 'country_name' => 'United States Minor Outlying Islands', 'phone_code' => 1],
            ...
            ['country_code' => 'VA', 'country_name' => 'Vatican City State Holy See', 'phone_code' => 39],
            ['country_code' => 'VE', 'country_name' => 'Venezuela', 'phone_code' => 58],
            ['country_code' => 'VN', 'country_name' => 'Vietnam', 'phone_code' => 84],
            ['country_code' => 'VG', 'country_name' => 'Virgin Islands British', 'phone_code' => 1284],
            ['country_code' => 'VI', 'country_name' => 'Virgin Islands US', 'phone_code' => 1340],
            ['country_code' => 'WF', 'country_name' => 'Wallis And Futuna Islands', 'phone_code' => 681],
            ['country_code' => 'EH', 'country_name' => 'Western Sahara', 'phone_code' => 212],
            ['country_code' => 'YE', 'country_name' => 'Yemen', 'phone_code' => 967],
            ['country_code' => 'YU', 'country_name' => 'Yugoslavia', 'phone_code' => 38],
            ['country_code' => 'ZM', 'country_name' => 'Zambia', 'phone_code' => 260],
            ['country_code' => 'ZW', 'country_name' => 'Zimbabwe', 'phone_code' => 263]
        ];
  
        foreach ($country as $key => $value) {
            $Country_added = Country::where(['country_name' => $value['country_name']])->first();
